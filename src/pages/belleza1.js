...
class Belleza1 extends React.Component {
  render() {
    return (
      <div>
          ...
          <div className="row text-center establecimientoCard">
            <div className="col">
              <div className="w-100">
                ...
                <p className="t">
                  Dirección: Carrera 70#11130 <br></br> Nº de personas en el
                  establecimiento: 3 <br></br> Horario: 10:00 - 9:00 <br></br>
            ...
            <div className="col">
              <div className="w-100">
                ...
                <p className="t">
                  ...
                  establecimiento: 2 <br></br> Horario: 8:00 - 7:00 <br></br>
